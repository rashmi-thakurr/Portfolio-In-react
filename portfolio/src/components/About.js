...
export default function About(){
    return (
       <div className="about-container about-c">
           <div className="about">
            <h1>Rashmi Thakur</h1>
            ...
            <p>
                ...
                <br/>
                <br/>
                I have worked as web-development intern at Redopact Private Limited, an early stage startup, developing an e-commerce web platform.
                <br/>
                <br/>
